...
Jeder Droid erhält einen zusätzlichen Flawless-Status.

UI:

✦ grau
= Flawless nicht freigeschaltet

✦ weiß
= Flawless freigeschaltet

Interaktion:

Antippen des Sterns schaltet Flawless um.

Mögliche Erweiterungen:

- Flawless Fortschritt (x/260)
- Flawless Filter
- Flawless Collection View

Architektur:

Collected = Besitzhistorie
Present = Aktuelle Verfügbarkeit
Flawless = Permanente kosmetische Freischaltung

Alle drei Zustände sind unabhängig voneinander.
